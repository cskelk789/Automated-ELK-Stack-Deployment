...
grep '0315' /home/sysadmin/Lucky_Duck_Investigations/Roulette_Loss_Investigation/Player_Analysis/Roulette_Losses | grep '05:00:00 AM' | awk '{print $1,$2,$3}' >> Dealers_working_during_losses
