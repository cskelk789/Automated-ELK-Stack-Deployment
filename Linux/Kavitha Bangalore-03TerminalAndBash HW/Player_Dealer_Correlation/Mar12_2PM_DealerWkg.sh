...
grep '0312' /home/sysadmin/Lucky_Duck_Investigations/Roulette_Loss_Investigation/Player_Analysis/Roulette_Losses | grep '02:00:00 PM' | awk '{print $1,$2,$3}' >> Dealers_working_during_losses
